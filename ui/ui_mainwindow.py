...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionEdit_Text.setChecked(False)
        icon4 = QtGui.QIcon()
        ...
        self.actionMoveStuffMode = QtWidgets.QAction(MainWindow)
        self.actionMoveStuffMode.setCheckable(True)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/img/move_crosshairs.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMoveStuffMode.setIcon(icon7)
        self.actionMoveStuffMode.setObjectName("actionMoveStuffMode")
        ...
        self.actionDelete_Tab = QtWidgets.QAction(MainWindow)
        self.actionDelete_Tab.setObjectName("actionDelete_Tab")
        self.actionCloseEntireApp = QtWidgets.QAction(MainWindow)
        self.actionCloseEntireApp.setObjectName("actionCloseEntireApp")
        self.actionNewLogicalRule = QtWidgets.QAction(MainWindow)
        self.actionNewLogicalRule.setObjectName("actionNewLogicalRule")
        ...
        self.menu.addAction(self.actionNewDiagram)
        self.menu.addAction(self.actionNewLogicalRule)
        ...
        self.menu.addSeparator()
        self.menu.addAction(self.actionDelete_Tab)
        ...
        self.toolBar.addAction(self.actionMoveStuffMode)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNewProof.setShortcut(_translate("MainWindow", "Ctrl+N"))
        self.actionNewDiagram.setText(_translate("MainWindow", "New Diagram"))
        self.actionNewDiagram.setShortcut(_translate("MainWindow", "Ctrl+T"))
        ...
        self.actionMoveStuffMode.setText(_translate("MainWindow", "Move Stuff"))
        self.actionMoveStuffMode.setToolTip(_translate("MainWindow", "Move stuff in the scene easily."))
        ...
        self.actionDelete_Tab.setText(_translate("MainWindow", "Delete Tab"))
        self.actionCloseEntireApp.setText(_translate("MainWindow", "Close Entire App"))
        self.actionNewLogicalRule.setText(_translate("MainWindow", "New Logical Rule"))
import resources_rc
