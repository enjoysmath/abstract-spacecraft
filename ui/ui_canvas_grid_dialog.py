...
class Ui_CanvasGridDialog(object):
    def setupUi(self, CanvasGridDialog):
        ...
        CanvasGridDialog.resize(298, 134)
        icon = QtGui.QIcon()
        ...
        self.ySpacingSpin.setMinimum(16)
        self.ySpacingSpin.setMaximum(1024)
        self.ySpacingSpin.setSingleStep(4)
        self.ySpacingSpin.setProperty("value", 128)
        ...
        self.xSpacingSpin.setMinimum(16)
        self.xSpacingSpin.setMaximum(1024)
        self.xSpacingSpin.setSingleStep(4)
        self.xSpacingSpin.setProperty("value", 128)
        ...
        self.buttonBox.accepted.connect(CanvasGridDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(CanvasGridDialog.reject) # type: ignore
