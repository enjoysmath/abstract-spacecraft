...
class Ui_LibrarySearchDockWidget(object):
    def setupUi(self, LibrarySearchDockWidget):
        ...
        LibrarySearchDockWidget.resize(444, 448)
        ...
        self.gridLayout.addWidget(self.searchButton, 2, 1, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.orderByComboBox, 1, 1, 1, 2)
        self.searchResultsScroll = QtWidgets.QScrollArea(self.searchResultsTab)
        self.searchResultsScroll.setWidgetResizable(True)
        self.searchResultsScroll.setObjectName("searchResultsScroll")
        self.searchResultsLayout = QtWidgets.QWidget()
        self.searchResultsLayout.setGeometry(QtCore.QRect(0, 0, 400, 299))
        self.searchResultsLayout.setObjectName("searchResultsLayout")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.searchResultsLayout)
        self.verticalLayout.setObjectName("verticalLayout")
        self.searchResultsScroll.setWidget(self.searchResultsLayout)
        self.gridLayout_3.addWidget(self.searchResultsScroll, 2, 0, 1, 3)
