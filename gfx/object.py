...
class Object(GraphicsShape, Bounded, Connectable, Container, CollisionResponsive, ColorFillable, \
    ...
    #def sceneEventFilter(self, watched, event):
            ...
            #print(event.type())
            #if event.type() in (QEvent.GraphicsSceneMouseMove, QEvent.GraphicsSceneDragMove):
                #if self._restoreTextPos is None:
                    #self._restoreTextPos = watched.pos()
                    
            #elif event.type() == QEvent.GraphicsSceneMouseRelease:
                #if self._restoreTextPos is not None:
                    #watched.setPos(self._restoreTextPos)
                    #self._restoreTextPos = None
